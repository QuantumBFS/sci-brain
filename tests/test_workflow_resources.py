"""Exercise moved resources in independent installs and the documented build check."""
...
@pytest.mark.parametrize("name", ["brainstorm-ideas", "how-to-download-ref", "write-paper"])
def test_relative_references_work_without_sibling_skills(tmp_path, name):
    installed = (tmp_path / name).resolve()
