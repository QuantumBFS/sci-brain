...
Distilled rule lists from the two source guides that back `write-paper/SKILL.md`. Use this when the main SKILL.md leaves a judgment call open, or when teaching a collaborator *why* a given rule exists.
